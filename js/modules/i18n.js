...
const translations = {
    en: {
        ...
        // Index
        'index.subtitle': 'A calm, simple way to manage health appointments and notes.',
        'index.welcome': 'Welcome',
        'index.description': 'Tagline helps you keep track of appointments, notes, and documents without the stress. No clutter, just what you need.',
        ...
        'appointments.import_desc': 'Upload an .ics file from your calendar (Google, Outlook, Helsenorge) to add appointments automatically.',
        ...
        'appointments.confirm_delete': 'Are you sure you want to delete this appointment?',
        ...
        'documents.warning': 'Note: Files are stored in your browser. Large files may not be saved.',
        ...
        'documents.alert.too_large': 'File is too large to store in the browser storage.',
        ...
        'settings.confirm_clear': 'WARNING: This will delete ALL your appointments, notes, and documents. This cannot be undone. Are you sure?',
    ...
    no: {
        ...
        // Index
        'index.subtitle': 'En rolig og enkel måte å holde oversikt over helseavtaler og notater.',
        'index.welcome': 'Velkommen',
        'index.description': 'Tagline hjelper deg å holde oversikt over avtaler, notater og dokumenter uten stress. Ingen rot, bare det du trenger.',
        ...
        'appointments.import_desc': 'Last opp en .ics-fil fra kalenderen din (Google, Outlook, Helsenorge) for å legge til avtaler automatisk.',
        ...
        'appointments.confirm_delete': 'Er du sikker på at du vil slette denne avtalen?',
        ...
        'medications.confirm_delete': 'Er du sikker på at du vil slette denne medisinen?',
        ...
        'symptoms.confirm_delete': 'Er du sikker på at du vil slette denne oppføringen?',

        // Documents
        'documents.upload': 'Last opp dokument',
        'documents.warning': 'Merk: Filer lagres i nettleseren din. Store filer blir kanskje ikke lagret.',
        ...
        'documents.confirm_delete': 'Er du sikker på at du vil slette dette dokumentet?',
        'documents.alert.too_large': 'Filen er for stor til å lagres i nettleseren.',
        ...
        'contacts.confirm_delete': 'Er du sikker på at du vil slette denne kontakten?',
        ...
        'vitals.confirm_delete': 'Er du sikker på at du vil slette denne oppføringen?',
        ...
        'settings.confirm_clear': 'ADVARSEL: Dette vil slette ALLE dine avtaler, notater og dokumenter. Dette kan ikke angres. Er du sikker?',
