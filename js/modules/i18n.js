...
const STORAGE_KEY = "huskelista_language";
...
const translations = {
  en: {
    ...
    "index.description":
      "Huskelista helps you keep track of appointments, notes, and documents without the stress. No clutter, just what you need.",
  ...
  no: {
    ...
    "index.description":
      "Huskelista hjelper deg å holde oversikt over avtaler, notater og dokumenter uten stress. Ingen rot, bare det du trenger.",
    ...
    "vitals.btn.add": "Logg måling",
    "vitals.history": "Historikk",
    "vitals.none": "Ingen målinger logget.",
    "vitals.confirm_delete": "Er du sikker på at du vil slette denne målingen?",
    ...
    "profile.label.emergency_phone": "Telefonnummer",
    "profile.placeholder.emergency_phone": "123 45 678",
